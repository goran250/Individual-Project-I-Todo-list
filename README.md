...
The app is a console app with a text based user interface that can be accessed through the command-line.
...
When the user is using the app, the user should be able to also list, edit and remove tasks. The user can also 
